    ...
    <div className="flex h-full w-64 flex-col border-r border-slate-200 bg-white">
      <div className="flex h-16 items-center px-6 border-b border-slate-200">
        <div className="flex items-center gap-2 font-bold text-xl text-green-700">
          <div className="h-8 w-8 rounded bg-green-600 flex items-center justify-center text-white">
            <Briefcase size={18} />
          </div>
          BMSO
        </div>
      ...
      <div className="flex-1 overflow-y-auto py-4">
        <nav className="space-y-1 px-3">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <item.icon className={cn("h-5 w-5", isActive ? "text-green-600" : "text-slate-400")} />
                {item.name}
              </Link>
            )
          })}
        ...
        <div className="mt-8">
          <div className="px-6 text-xs font-semibold uppercase tracking-wider text-slate-500 mb-2">
            Encoding
          </div>
          <nav className="space-y-1 px-3">
      ...
      <div className="border-t border-slate-200 p-4">
        <div className="flex items-center gap-3 rounded-md px-3 py-2 hover:bg-slate-50 cursor-pointer transition-colors">
